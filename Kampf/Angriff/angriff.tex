...
\textbf{\underline{Ansage}:} Freiwillige \underline{\textit{plus}} geforderte Erschwernis.
\textbf{\underline{Misslungen}}: nächste Aktion um gesamte \textbf{Ansage} erschwert.
...
\begin{center}
    \begin{tikzpicture}[node distance = 3cm, auto]
        ...
        \node [block, below left of=atk] (ssja) {Erschw. +2 (+1 \textbf{S} / +2 \textbf{M})};
